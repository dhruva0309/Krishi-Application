...
if (isset($_REQUEST['fname'])){
    ...
    $spid = stripslashes($_REQUEST['spid']);
	$spid = mysqli_real_escape_string($con,$spid);
	...
	$mess = mysqli_real_escape_string($con,$mess);
        ...
        $query = "INSERT into `feedback` (fname,spid,rating,mess)
VALUES ('$fname','$spid','$rating','$mess')";
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
										...
										<div class="form-group">
												<label class="col-md-3 control-label" for="inputRounded"><b>Farmer Name</b></label>
												<div class="col-md-6">
													<input   name= "fname" type="text"  readonly value="<?php echo $_SESSION['username'];?>" class="form-control input-rounded" id="inputRounded" required>
												</div>
											</div>
											
						
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputRounded"><b>SPID</b></label>
												<div class="col-md-6">
													<input type="text"  name= "spid" class="form-control input-rounded" id="inputRounded" required>
												</div>
											</div>
						
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputRounded"><b>Rating </b></label>
												<div class="col-md-6">
													<input type="range"  name= "rating" class="form-control input-rounded" id="inputRounded" required>
												</div>
											</div>
