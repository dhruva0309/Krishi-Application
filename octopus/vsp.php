...
?>
      ...
      { ?>
												<tbody>
                                                    ...
                                                    <td class=" "><a href="spdelete.php?id=<?php echo $data['sid']; ?>" class="btn btn-sm btn-primary login-submit-cs" onclick="return confirm('Are You Sure')">DELETE</td>
