...
?>
      ...
      { ?>
												<tbody>
                                                    ...
                                                    <td class=" "><?php echo $data['stitle']; ?></td>
                                                    <td class=" "><?php echo $data['cat']; ?></td>
                                                    <td class=" "><?php echo $data['region']; ?></td>
                                                    <td class=" "><img src="image/<?php echo $data['image']; ?>"width="200"></td>
                                                    <td class=" "><?php echo $data['address']; ?></td>
                                                   
                                                    <td class=" "><a href="supdate.php?id=<?php echo $data['spid']; ?>" class="btn btn-sm btn-primary login-submit-cs" onclick="return confirm('Are You Sure')">UPDATE</td>
                                                    <td class=" "><a href="sdelete.php?id=<?php echo $data['spid']; ?>" class="btn btn-sm btn-primary login-submit-cs" onclick="return confirm('Are You Sure')">DELETE</td>
