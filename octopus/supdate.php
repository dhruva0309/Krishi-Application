...
?>
  <?php while($data = mysqli_fetch_array($result))
      { ?>
										...
										<form class="form-horizontal form-bordered" action="ssupdate.php" method="post">
											
						
											
										<div class="form-group">
												<label class="col-md-3 control-label" for="inputRounded">SPID</label>
												<div class="col-md-6">
													<input type="text"  name= "spid" readonly value="<?php echo $data['spid'];?>" class="form-control input-rounded" id="inputRounded"  required>
												</div>
											</div>
                                            <div class="form-group">
												<label class="col-md-3 control-label" for="inputRounded">Service Title</label>
												<div class="col-md-6">
													<input type="text"  name= "stitle" value=" <?php echo $data['stitle'];?>" class="form-control input-rounded" id="inputRounded"  required>
												</div>
											</div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<input   name= "image" value="<?php echo $data['image'];?>"  type="file" class="form-control input-rounded" id="inputRounded" required>
												</div>
											</div>
                                            <div class="form-group">
