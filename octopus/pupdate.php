...
?>
  <?php while($data = mysqli_fetch_array($result))
      { ?>
										...
										<form class="form-horizontal form-bordered" action="ppupdate.php" method="post">
											
						
											
										<div class="form-group">
												<label class="col-md-3 control-label" for="inputRounded">PID</label>
												<div class="col-md-6">
													<input type="text"  name= "pid" readonly value="<?php echo $data['pid'];?>" class="form-control input-rounded" id="inputRounded"  required>
												</div>
											</div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<input   name= "price"  value="<?php echo $data['price'];?>" type="text" class="form-control input-rounded" id="inputRounded" required>
												</div>
											</div>
