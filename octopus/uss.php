...
if (isset($_REQUEST['asignal'])){
	...
	$trn_date = date("Y-m-d H:i:s");
        $query = "INSERT into `ss` (asignal,ft,tt,sstatus, trn_date)
VALUES ('$asignal','$ft','$tt','$sstatus',  '$trn_date')";
...
?>
	<body>
	 ...
	 $a=$_SESSION['username'];
	 $a= $_GET['id'];
	 $query="SELECT * from ss WHERE ssid ='$a' " ;
...
?>
 <?php while($data = mysqli_fetch_array($result))
      { ?>
										...
										<form class="form-horizontal form-bordered" action="uuss.php" method="post">
											
                                        <div class="form-group">
												<label class="col-md-3 control-label" for="inputRounded">SSID</label>
												<div class="col-md-6">
													<input   name= "ssid" type="text" readonly value="<?php echo $data['ssid'];?>" class="form-control input-rounded" id="inputRounded" required>
												</div>
											</div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <select class="form-control input-sm mb-md" name= "asignal" required>
														<option><?php echo $data['asignal'];?></option>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<input   name= "ft" type="time" value="<?php echo $data['ft'];?>" class="form-control input-rounded" id="inputRounded" required>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<input   name= "tt" type="time" value="<?php echo $data['tt'];?>" class="form-control input-rounded" id="inputRounded" required>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													...
													<select class="form-control input-sm mb-md" name= "sstatus" required>
														<option><?php echo $data['sstatus'];?></option>
														<option>ON</option>
														<option>OFF</option>
