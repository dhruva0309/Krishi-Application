		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="#" class="logo">
						<img src="assets/images/logo.png"  height="47" alt="Porto Admin" />
					</a>
...
?>
									...
									<div id="edit" class="tab-pane">
										...
										<form class="form-horizontal" action="ufprofile.php" method="post">
      ...
      { ?>
                                               <div class="form-group">
													...
													<div class="col-md-8">
														<input type="text" class="form-control" name="fid" readonly value="<?php echo $data['fid'] ;?>">
													</div>
												</div>
