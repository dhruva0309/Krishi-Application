...
if (isset($_REQUEST['username'])){
	...
	$vn = stripslashes($_REQUEST['vn']);
	$vn = mysqli_real_escape_string($con,$vn);
	$password = stripslashes($_REQUEST['password']);
	$password = mysqli_real_escape_string($con,$password);
	$trn_date = date("Y-m-d H:i:s");
        $query = "INSERT into `dusers` (username,fullname,location,phone, vn, password, trn_date)
VALUES ('$username','$fullname','$location','$phone', '$vn','".md5($password)."', '$trn_date')";
					...
					<!-- start: page -->
										...
										<form action="" class="form-horizontal form-bordered" method="post">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<input   name= "phone" type="tel" maxlength="10" class="form-control input-rounded" id="inputRounded" required>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="vn" class="form-control"  id="inputPassword" required>
												</div>
											</div>
