...
<html class="fixed">
	...
	<body>
					...
					<div id="userbox" class="userbox">
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								<li class="divider"></li>
								<li>
								<a role="menuitem" tabindex="-1" href="fprofile.php"><i class="fa fa-power-off"></i> My Profile</a>
</li>
								<li>
	 ...
	 error_reporting(0);
	 $a=$_SESSION['username'];
	 $query= "SELECT * FROM fusers WHERE username='$a'" ;
...
?>
      ...
      { ?>
                                               <div class="form-group">
													...
													<div class="col-md-8">
														<input type="text" class="form-control" readonly value="<?php echo $data['fid'] ;?>">
													</div>
												</div>
												<div class="form-group">
												...
												<div class="row">
													...
													<center>	<button type="button" class="btn btn-primary">  <a href="efprofile.php?id=<?php echo $data['fid'];?>"  onclick="return confirm('Are You Sure')">EDIT</button></center>
