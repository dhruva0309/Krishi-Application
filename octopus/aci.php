...
if (isset($_REQUEST['fname'])){
	...
	$hmonth = stripslashes($_REQUEST['hmonth']);
	$hmonth = mysqli_real_escape_string($con,$hmonth);
	$quantity = stripslashes($_REQUEST['quantity']);
	$quantity = mysqli_real_escape_string($con,$quantity);
	
        $query = "INSERT into `cinfo` (fname,cat,region,hmonth,quantity)
VALUES ('$fname','$cat','$region','$hmonth', '$quantity')";
        $result = mysqli_query($con,$query);
        if($result){
           echo"Record inserted";?>
		<script type="text/javascript">
            window.alert("successfully INFO Added");
            window.location="aci.php";
            </script>
			<?php 
        }
    }else{
					...
					<!-- start: page -->
										...
										<form class="form-horizontal form-bordered" action="" method="post">
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputRounded">Farmer Name</label>
												<div class="col-md-6">
													<input type="text"  name= "fname" readonly value="<?php echo $_SESSION['username'];?>" class="form-control input-rounded" id="inputRounded"  required>
												</div>
											</div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<input   name= "quantity" type="text" class="form-control input-rounded" id="inputRounded" required>
												</div>
											</div>
