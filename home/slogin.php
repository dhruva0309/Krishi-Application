...
and password='".md5($password)."'";
	...
	$rows = mysqli_num_rows($result);
	    ...
	    header("Location: http://localhost/krushi/octopus/sdashboard.php");
         }else{
	echo "<div class='form'>
<h3>Username/password is incorrect.</h3>
<br/>Click here to <a href='slogin.php'>Login</a></div>";
	}
    }else{
?>
<body>
          ...
          <form action="" method="post">
            ...
            <div class="row">
                                <div class="col-md-12">
                                  ...
                                  <p>Not registered yet? <a href='sregister.php'>Register Here</a></p>
                                        <p><a href='sforgot.php'>Forgot Password ??</a></p>    
